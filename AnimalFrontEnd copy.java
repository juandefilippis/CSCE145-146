...
public class AnimalFrontEnd { 
 ...
 {  
  ...
  pLName = kb.nextLine(); 
  type = kb.nextLine();
  return new Wolf(name, weight, energyLevel, pLName);  
 } 
 ...
 {  
  ...
  spots = Integer.parseInt(scanner.nextLine()); 
  return new Leopard(mood, name, weight, spots);  
 } 
 ...
 {  
  ...
  mood = scanner.nextLine(); 
  type = scanner.nextLine(); 
  return new HouseCat(mood, name, weight, type); 
 } 
